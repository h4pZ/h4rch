...
let g:which_key_map.d = {
      ...
      \ 'B' : [':execute "lua require(\"dap\").step_back()"' , 'Step Back'],
      \ 'c' : [':execute "lua require(\"dap\").continue()"' , 'Continue'],
      \ 'C' : [':execute "lua require(\"dap\").run_to_cursor()"' , 'Run To Cursor'],
      \ 'd' : [':execute "lua require(\"dap\").disconnect()"' , 'Disconnect'],
      \ 'g' : [':execute "lua require(\"dap\").session()"' , 'Get Session'],
      \ 'i' : [':execute "lua require(\"dap\").step_into()"' , 'Step Intro'],
      \ 'o' : [':execute "lua require(\"dap\").step_over()"' , 'Step Over'],
      \ 'u' : [':execute "lua require(\"dap\").step_out()"' , 'Step Out'],
      \ 'p' : [':execute "lua require(\"dap\").pause.toggle()"' , 'Pause'],
      \ 'r' : [':execute "lua require(\"dap\").repl.toggle()"' , 'Toggle Repl'],
      \ 's' : [':execute "lua require(\"dap\").cotinue()"' , 'Start'],
      \ 'q' : [':execute "lua require(\"dap\").stop()"' , 'Quit'],
      \ }
